...
RecipeIndex.getInitialProps = function _callee(context) {
  var query, queryPath, replaceChar, cleanPath, cleanedPath, response, data;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          cleanPath = function _cleanPath() {
            var cleanedPath = queryPath.replace(/%2C|%20/gi, function (matched) {
          ...
          console.log(queryPath, cleanedPath); //console.log(query, context.pathname, context.asPath, context.res); undefined, /recipes, /recipes?q=flour, undefined
...
//# sourceMappingURL=recipes.js.5a9c6759cd9e155db46d.hot-update.js.map