...
RecipeIndex.getInitialProps = function _callee(context) {
  var queryPath, response, data;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          queryPath = context.query.q.replace(" ", "+"); // const queryPath = context.asPath;
          ...
          _context.next = 4;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(fetch("https://api.spoonacular.com/recipes/findByIngredients?ingredients=".concat(queryPath, "&apiKey=").concat("e4dae24ad2ad4d6cb33e377041aa1e0b")));
...
//# sourceMappingURL=recipes.js.2cde6ef0394d39df82c4.hot-update.js.map