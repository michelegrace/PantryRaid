...
RecipeIndex.getInitialProps = function _callee(context) {
  var query, queryPath, response, data;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          query = context.query.q.query;
          queryPath = context.asPath;
          console.log(typeof queryPath); //console.log(query, context.pathname, context.asPath, context.res); undefined, /recipes, /recipes?q=flour, undefined
...
//# sourceMappingURL=recipes.js.7f86aa40e835951794b3.hot-update.js.map