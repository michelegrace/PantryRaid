...
RecipeIndex.getInitialProps = function _callee(context) {
  var _context$query$q$repl, query, queryPath, replaceChar, cleanedPath, response, data;

  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context$query$q$repl = context.query.q.replace(" ", "+"), query = _context$query$q$repl.query;
          queryPath = context.asPath; //clean up queryPath to match better what the api expects if using context.asPath
          ...
          console.log("".concat(query), context.query.q, context.query, context.pathname, context.asPath, context.res);
          _context.next = 7;
...
//# sourceMappingURL=recipes.js.d2ddd9c9b43673736463.hot-update.js.map